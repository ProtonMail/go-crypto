...
func TestSignVerify(t *testing.T) {
	...
	params := map[string] sphincs_plus.ParameterSetId {
		"1": sphincs_plus.Parameter1,
		"2": sphincs_plus.Parameter2,
		"3": sphincs_plus.Parameter3,
		"4": sphincs_plus.Parameter4,
		"5": sphincs_plus.Parameter5,
		"6": sphincs_plus.Parameter6,
	}
