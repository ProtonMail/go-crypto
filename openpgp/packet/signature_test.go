...
func TestSignatureWithRecoverableFlag(t *testing.T) {
	packet, err := Read(readerFromHex(signatureWithRecoverableFlagHex))
	if err != nil {
		t.Error(err)
		return
	}
	...
	expected, _ := hex.DecodeString(signatureWithRecoverableFlagHex)
	if !bytes.Equal(expected, out.Bytes()) {
		t.Errorf("output doesn't match input (got vs expected):\n%s\n%s", hex.Dump(out.Bytes()), hex.Dump(expected))
	}
}
...
const signatureWithRecoverableFlagHex = ""
